...
model = dict(
    ...
    freeze_cfg=dict(
        ...
        trainable_keywords=[
            ...
            'pts_bbox_head.conditional_cbam'
        ],
        freeze_bn=True,
        verbose=True),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='data/10p_balanced_subset/vad_nuscenes_infos_temporal_train_balanced_10p.pkl',
...
load_from = '/data3_server8/wanghongxuan/SSR/ckpts/ssr.pth'
